...
describe('Sum is Odd', () => {
    ...
    it('should return false if inputs are added to be Even', () => {
        expect(sumIsOdd(4, 6)).toBe(false);
    });
});
...
describe('FizzBuzzArray', () => {
    ...
    it('should return the correct array for a length of 16', () => {
        expect(fizzBuzzArray(16)).toEqual([
            1, 2, "fizz", 4, "buzz", "fizz", 7, 8, "fizz", "buzz", 11, "fizz", 13, 14, "fizzbuzz", 16
        ]);
    })

    it('should return the correct array for a length of 100', () => {
        expect(fizzBuzzArray(100)).toEqual([
...
describe('objectFetch', () => {
    it('should fetch the object and filter correctly for the values it fetches', async () => {
        const answer = await objectFetch();
